...
describe('Selector', () => {
  it('should create using constructor', () => {
    expect(new Selector(SelectorType.GLOBAL)).toEqual({
      "modifier": null,
      "name": null,
      "operator": null,
      "type": "global",
    ...
    expect(new Selector(SelectorType.COMBINATOR, null, '>')).toEqual({
      "modifier": null,
      "name": null,
      "operator": null,
      "type": "combinator",
    ...
    expect(new Selector(SelectorType.ATTRIBUTE, 'id', 'unique')).toEqual({
      "modifier": null,
      "name": "id",
      "operator": null,
      "type": "attribute",
    ...
    expect(new Selector(SelectorType.ATTRIBUTE, 'class', 'item', '^')).toEqual({
      "modifier": null,
      "name": "class",
      "operator": "^",
      "type": "attribute",
    ...
    expect(new Selector(SelectorType.ATTRIBUTE, 'href', '/path', '$', 's')).toEqual({
      "modifier": "s",
      "name": "href",
      "operator": "$",
      "type": "attribute",
